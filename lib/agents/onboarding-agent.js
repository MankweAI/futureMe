...
class OnboardingAgent {
  ...
  async processMessage(userMessage, session, userStatus) {
    ...
    if (currentStage === STAGES.START) {
      response =
        "Welcome to Christ Connect! 🙏✨\n\nWe're building a safe, Christ-centered community for believers to find:\n🙏 Prayer Partners\n🤝 Fellowship & Friends\n💛 Meaningful Connections\n\nWe're so excited you're here! **This week, we are onboarding our Founding Members.** Then, on **Nov 24th, we officially LAUNCH!** 🚀\n\nLet's start with a few quick questions.\n\nFirst, what’s your first name? 🌿";
    ...
    // --- Subsequent Steps ---
      ...
      switch (lastStage) {
        ...
        // --- Step 5: COMPLETE / Celebration (REVISED) ---
