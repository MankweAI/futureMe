  ...
  async processMessage(userMessage, session, userStatus) {
    ...
    switch (currentStage) {
      ...
      case STAGES.DATING_Q4_PHOTO:
        ...
        // Note: 'session.lastMessageType' must be populated by webhook.js
        if (
          ...
          // Fallback if they typed text instead of sending a photo
      ...
      case STAGES.FRIEND_Q1_INTENT:
        ...
        response =
          ...
          "So I don't match you with a Gogo (unless you want that! 😅), **tell me your age, gender, and where you're from?**";
      ...
      case STAGES.FRIEND_Q4_PREFS:
        ...
        // IMMEDIATE MATCH SIMULATION
        response =
          "Done! I found someone. ✨\n\n" +
          "Meet **Thabo (25)**. He’s also into those interests.\n" +
          "I’m connecting you two now...\n\n" +
          "*(System: You are now connected. Say 'Hi'!)*";
        nextStage = STAGES.COMPLETE;
        break;
