...
const applicationAgent = require("./application-agent-mvp");
const profileAgent = require("./profile-agent");
const careerAgent = require("./career-agent");
const bursaryListerAgent = require("./bursary-lister-agent.js");
const contactAgent = require("./contact-agent.js"); // <-- ADDED

function determineTargetAgent(intent, session) {
  switch (intent) {
    case "bursary_application":
      return applicationAgent;
    case "available_bursaries":
      return bursaryListerAgent;
    case "view_profile":
      return profileAgent;
    case "contact_us": // <-- ADDED
      return contactAgent; // <-- ADDED
